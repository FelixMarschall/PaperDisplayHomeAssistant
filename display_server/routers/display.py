...
async def test():
    try:
        ...
        draw.text((10, 160), "微雪电子", font=font30, fill=epd.BLACK)
        draw.text((10, 200), "微雪电子", font=font30, fill=epd.ORANGE)
        draw.text((10, 240), "微雪电子", font=font30, fill=epd.GREEN)
        draw.text((10, 280), "微雪电子", font=font30, fill=epd.BLUE)
        draw.text((10, 320), "微雪电子", font=font30, fill=epd.RED)
        draw.text((10, 360), "微雪电子", font=font30, fill=epd.YELLOW)
        ...
        Himage = Image.new(
            "RGB", (epd.height, epd.width), 0xFFFFFF
        )  # 255: clear the frame
        draw = ImageDraw.Draw(Himage)
        draw.text((10, 0), "hello world", font=font24, fill=0)
        draw.text((10, 20), "5.83inch e-Paper", font=font24, fill=0)
